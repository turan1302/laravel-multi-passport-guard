...
class indexController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $create = MembersModel::create($input);
    ...
    public function login(Request $request)
    {
        ...
        $member = MembersModel::where("email", $credentials['email'])->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($input['email'] != $user->email) {
            $control = MembersModel::where("id", "!=", $user->id)->where("email", $input['email'])->first();
            if ($control) {
                return response()->json([
                    "success" => false,
                    "title" => "Hata",
        ...
        $update = MembersModel::where("id", $user->id)->update($input);
